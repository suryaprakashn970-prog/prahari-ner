...
export const translations = {
  en: {
    common: {
      ...
      systemOnlineConnected: "System Online — API Connected",
      systemOfflineUnreachable: "System Offline — Server Unreachable",
  ...
  hi: {
    common: {
      ...
      checkingConnection: "कनेक्शन की जाँच हो रही है...",
      systemOnline: "सिस्टम ऑनलाइन",
      systemOffline: "सिस्टम ऑफ़लाइन",
      systemOnlineConnected: "सिस्टम ऑनलाइन — एपीआई कनेक्टेड",
      systemOfflineUnreachable: "सिस्टम ऑफ़लाइन — सर्वर अनुपलब्ध",
